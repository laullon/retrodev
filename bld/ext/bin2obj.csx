...
public class Bin2obj {
	...
	/// <summary>
	/// Indicates whether the files were processed or not. 
	/// This can be used by the build system to determine if it needs to re-link the final executable.
	/// </summary>
	public bool WasProcessed { get; private set; } = false;
